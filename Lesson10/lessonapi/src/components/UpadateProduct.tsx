...
export default function UpadateProduct({ product, onUpdate }: any) {
        ...
        <div className='row'>
            ...
            <form action="" className='col-3' id=''>
                <div>
                    ...
                    <input type="text" value={id} name="id" id="id" onChange={(evt) => setId(evt.target.value)} readOnly />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="radio" name="status" id="con" checked ={status===true} onChange={(evt) => setStatus(true)} />
                    <label htmlFor="het">Hết hàng</label>
                    <input type="radio" name="status" id="het" checked ={status===false}  onChange={(evt) => setStatus(false)} />
                </div>
